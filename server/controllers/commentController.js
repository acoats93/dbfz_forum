module.exports = {
    ...
    addComment: async (req,res) => {
        ...
        const {user_id, comment_content, username} = req.body;
        const newComment = await db.addComment(user_id, comment_content, username);
    ...
    editComment: async (req,res) => {
        ...
        const updatedComment = await db.editComment(comment_id, comment_content);
